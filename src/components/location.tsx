              ...
              <div key={policy.number} className="policy-card border border-gold/15 bg-white p-7 hover:border-gold/40 transition-all duration-500">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div className="flex items-baseline gap-2.5">
                    ...
                    <h3 className="font-serif text-lg text-anthracite leading-snug">{t(`policy.${parseInt(policy.number)}.title`)}</h3>
                  </div>
                </div>
                <p className="text-gray-500 font-light leading-relaxed text-[13.5px] pl-[52px]">{t(`policy.${parseInt(policy.number)}.text`)}</p>
              </div>
            ))}
          </div>
        </div>
